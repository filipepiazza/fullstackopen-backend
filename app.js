...
morgan.token("bodytype", function (req, res, next) {
  return req.bodyType;
});
...
app.use(
  morgan(
    ":method :url :status :res[content-length] - :response-time ms :bodytype"
  )
);
...
if (process.env.NODE_ENV === "test") {
  console.log("adding testing router in test mode");
